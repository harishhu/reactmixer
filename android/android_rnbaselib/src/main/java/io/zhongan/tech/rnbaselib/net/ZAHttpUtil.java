...
import io.zhongan.tech.rnbaselib.utils.FileUtils;
...
public class ZAHttpUtil {
	...
	/**
	 * 众安http get请求，会对众安平台的请求和返回数据做相关处理
	 * <pre class="prettyprint">
	 * sample code:
	 * zaHttpResult hr = zaHttpUtil.zaHttpGet("http://bops.daily.zhonganonline.com/api/products.json", null, 30000);
	 * </pre>
	 * */
	...
	/**
	 * 众安http post请求，会对众安平台的请求和返回数据做相关处理
	 * */
