...
public class RNConstants {
	 ...
	 * webview的默认action
	 * */
	public static final String ACTION_PRODUCT_DEFAULT_URL = "com.react.information.webview.product.defaulturl";

	public static final String ACTION_REACTNATIVE_BASEENTRY = "hu.react.mixer.reactnative.baseentry";
