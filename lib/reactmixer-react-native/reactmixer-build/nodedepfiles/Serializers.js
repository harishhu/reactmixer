 ...
 * 
 * @format
 * @path: metro/src/deltabundler/serializers/Serializers.js
 */

'use strict';
//add by harish.hu - 2018-07-24
...
let deltaBundle = (() => {
  var _ref = _asyncToGenerator(
    ...
    function* (
      ...
      options) {
      var _ref2 =
        yield _build(deltaBundler, clientId, options);
      const delta = _ref2.delta;

      function stringifyModule(_ref3) {
  ...
  return function deltaBundle(_x, _x2, _x3) {
...
let fullSourceMap = (() => {
  var _ref5 = _asyncToGenerator(
    ...
    function* (
      ...
      options) {
      var _ref6 =
        yield _getAllModules(deltaBundler, options);
      const modules = _ref6.modules;
  ...
  return function fullSourceMap(_x4, _x5) {
    return _ref5.apply(this, arguments);
  };
})();
let fullSourceMapObject = (() => {
  ...
  return function fullSourceMapObject(_x6, _x7) {
...
let fullBundle = (() => {
    ...
    function* (
      ...
      var _ref10 =
        yield _getAllModules(
          deltaBundler,
          options);
      const modules = _ref10.modules,
        numModifiedFiles = _ref10.numModifiedFiles,
        lastModified = _ref10.lastModified;


      const code = modules.map(function (m) {
        //add by harish.hu - 2018-07-24
        zakjbuildhelper.filterModuleCode(m);
        return m.code;
      });
  ...
  return function fullBundle(_x8, _x9) {
...
let getAllModules = (() => {
  var _ref11 = _asyncToGenerator(
    ...
    function* (
      ...
      var _ref12 =
        yield _getAllModules(deltaBundler, options);
      const modules = _ref12.modules;

      return modules;
    });
  return function getAllModules(_x10, _x11) {
...
let _getAllModules = (() => {
...

    {
      ...
      var _ref14 =
        ...
        yield _build(
          ...
          clientId,
          options);
      const delta = _ref14.delta,
        deltaTransformer = _ref14.deltaTransformer;
  ...
  return function _getAllModules(_x12, _x13) {
    return _ref13.apply(this, arguments);
  };
})();
let getRamBundleInfo = (() => {
    ...
    function* (
      ...
      var _ref16 =
        yield _getAllModules(
          deltaBundler,
          options);
      const modules = _ref16.modules,
        deltaTransformer = _ref16.deltaTransformer;


      const ramModules = modules.map(function (module) {
        return {
          id: module.id,
          code: module.code,
      ...
      var _ref17 =
        ...
        yield RamBundle.getRamOptions(
          ...
          getTransformOptions);
      const preloadedModules = _ref17.preloadedModules,
        ramGroups = _ref17.ramGroups;
  ...
  return function getRamBundleInfo(_x14, _x15, _x16) {
...
let getAssets = (() => {
  var _ref18 = _asyncToGenerator(
    ...
    function* (
      ...
      var _ref19 =
        yield _getAllModules(deltaBundler, options);
      const modules = _ref19.modules;

      const assets = yield Promise.all(
        modules.map((() => {
          var _ref20 = _asyncToGenerator(function* (module) {
  ...
  return function getAssets(_x17, _x18, _x19) {
...
const getAssetData = _require.getAssetData;
var _require2 = require('../../Bundler/util');
const createRamBundleGroups = _require2.createRamBundleGroups;
var _require3 = require('metro-source-map');
const fromRawMappings = _require3.fromRawMappings;
