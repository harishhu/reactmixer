...
const APPLET_ROOT_DIR = 'src' + fileseperator + 'app-modules';
...
class BuildHelper {
    ...
    initAppletsMap(){
        ...
        let index = 0;
        let path = this.pwdpath + fileseperator + APPLET_ROOT_DIR;
        ...
        if (fs.existsSync(path)) {
            ...
            for (var i in arr) {
                ...
                if (!stats.isFile()) {
                    ...
                    config.modulecode = [];
                    config.moduleres = [];
                    config.subpath = APPLET_ROOT_DIR + fileseperator + name;
    ...
    createModuleIdFactory() {
            ...
            return path => {
                ...
                if (path.indexOf(APPLET_ROOT_DIR) == 0) {
